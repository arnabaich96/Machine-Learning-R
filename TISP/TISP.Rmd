...
rplot = Roc_plot(100,2265200,eta=1/nrow(data_train$y),data_train,data_test)
ggplotly(rplot)
```
...
u=parSapply(my.cluster,lambda_all,TISP,100,data_train,data_test)
...
## Roc plot for approximately 500 feature
```{r}
ggplotly(Roc_plot(100,lambda=1098,eta=1/nrow(data_train$y),data_train,data_test))
```
...
```{r}
ggplotly(Roc_plot(100,lambda=4213,eta=1/nrow(data_train$y),data_train,data_test))
```
